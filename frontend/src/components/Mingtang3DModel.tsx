...
import { MINGTANG_DIMENSIONS, DEFAULT_WINDOWS, SENSOR_LOCATIONS, WOOD_MATERIAL, WALL_MATERIAL, ROOF_MATERIAL, WINDOW_MATERIAL, GOLD_DECORATION } from '@/utils/buildingData';
